...
docs/cli/index.md: src/cmipcite/cli/__init__.py  ## auto-generate the typer app docs
	uv run typer cmipcite.cli utils docs --output docs/cli/index.md --name cmipcite
